...
(deftest testing-report-difference
         ...
         (is (= (uncolorize (report-difference {:1 :2 :3 :4} {:1 :3 :3 :4})) "{:1 <:2|:3> :3 :4}"))
         (is (= (uncolorize (report-difference {:1 :2} {})) "{<:1 :2|>}"))
         (is (= (uncolorize (report-difference {:1 :2} {:1 nil})) "{:1 <:2|>}"))
         (is (= (uncolorize (report-difference {} {:1 :2})) "{<|:1 :2>}"))
         ;; (is (= (uncolorize (report-difference {:1 {:2 :3}} {:1 {:2 :4}})) "{:1 {:2 <:3|:4>}}"))
         (is (= (uncolorize (report-difference {:1 {:2 :3}} {:1 {:3 :4}})) "{:1 <{:2 :3}|{:3 :4}>}"))
         )
